        ...
        <div class="row">
          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <?php $txtKode = array('name' => 'nama','value' => $menu[0]['menu_name'], 'class' => 'form-control', 'placeholder' => 'Masukan Nama Menu', 'autofocus' =>'autofocus');
      	     echo form_input($txtKode);?>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Harga</label>
              <?php $txtNama = array('name' => 'harga','value' => $menu[0]['menu_price'], 'class' => 'form-control', 'placeholder' => 'Masukkan harga menu');
